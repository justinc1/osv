...
#
xmodules.append(os.path.join(osv_dir, '../mike-apps/open-mpi/ompi-release/build-osv-symbols/orte/tools/orted/.libs'))
xmodules.append(os.path.join(osv_dir, '../mike-apps/open-mpi/ompi-release/build-osv-symbols/orte/tools/orterun/.libs/'))
xmodules.append(os.path.join(osv_dir, '../mike-apps/open-mpi/ompi-release/build-osv-symbols/ompi/.libs'))
xmodules.append(os.path.join(osv_dir, '../mike-apps/open-mpi/ompi-release/build-osv-symbols/opal/.libs/'))
xmodules.append(os.path.join(osv_dir, '../mike-apps/open-mpi/ompi-release/build-osv-symbols/orte/.libs'))
